...
This tells us that the most busy interval, on average, was `r mostactiveinterval`.
...
So there are `r missingvalues` missing values, out of a total of `r allvalues`.
...
The mean number of steps taken per day is `r mean2` (compared to the previous value of `r mean1`).

The median number of steps taken per day is `r median2` (compared to the previous value of `r median1`).
